    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 hero-content" data-aos="fade-right">
                ...
                <p>Découvrez la plus grande plateforme d'enchères en ligne. Des milliers de produits uniques vous attendent. Enchérissez, gagnez et économisez !</p>
            ...
            <div class="col-lg-6 text-center" data-aos="fade-left">
                <div class="floating">
                    <img src="https://cdn-icons-png.flaticon.com/512/10012/10012129.png" alt="Auction" class="img-fluid" style="max-width: 80%;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="search-input-group">
                    <input type="text" id="searchInput" class="form-control" placeholder="Rechercher un produit, une marque ou une catégorie...">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="email" class="form-control" placeholder="Votre adresse email" id="newsletterEmail">
    ...
    function loadProducts(page = 1, search = '') {
        ...
        $.ajax({
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="${product.image || 'https://via.placeholder.com/300x250?text=Product'}" alt="${product.titre}">
                                    <div class="product-badge ${isHot ? 'hot' : ''}">
                                        ${isHot ? '🔥 Tendance' : '🎯 Nouveau'}
                                    </div>
                                </div>
                                <div class="product-body">
                                    <h5 class="product-title">${product.titre}</h5>
                                    <div class="mb-2">
            ...
            error: function(xhr) {
                ...
                if (page === 1) {
                    $('#productsContainer').html('<div class="col-12 text-center"><p>Erreur de chargement des produits</p></div>');
                }
            }
        });
    }
