        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Modifier : {{ $category->nom }}</h6>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-outline mb-3">
                                ...
                                <input type="text" name="icone" class="form-control" value="{{ old('icone', $category->icone) }}" placeholder="ex: category, devices, home">
                            </div>
