{{-- /opt/lampp/htdocs/gestion_des_encheres/resources/views/admin/categories/create.blade.php --}}
@extends('layouts.app')
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-theme shadow-lg border-radius-lg pt-4 pb-3 rounded-4">
                        <h6 class="text-white text-capitalize ps-3 mb-0 fw-bold">
                            <i class="material-symbols-rounded me-1 align-middle">add_circle</i> Nouvelle Catégorie
                        </h6>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="icone" class="form-control rounded-3" value="{{ old('icone') }}"
                                    placeholder="ex: category, devices, home">
